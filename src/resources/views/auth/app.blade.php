...
<head>
    ...
    <link media="all" type="text/css" rel="stylesheet" href="/pondol/auth/init.css">
    {{--Styles--}}
    @yield('styles')
    <!-- Styles -->
    ...
    <script src="/pondol/auth/route.js?v=10"></script>
    <script src="/pondol/auth/common.js"></script>
  </head>
